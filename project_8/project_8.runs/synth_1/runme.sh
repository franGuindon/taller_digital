...
HD_PWD='C:/Users/CHRISUS/Taller/project_8/project_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CODDEC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CODDEC.tcl
